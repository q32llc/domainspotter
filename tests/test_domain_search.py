...
from domainspotter.models import DomainEntry, Domains, Idea
        ...
        MagicMock(
            message=MagicMock(
                parsed=Domains(
                    domains=[
                        DomainEntry(
                            domain="testidea.com", reason="Simple and memorable domain name"
                        ),
                        DomainEntry(domain="testidea.io", reason="Modern TLD for tech companies"),
                        DomainEntry(
                            domain="testidea.ai", reason="AI-focused TLD for innovative businesses"
                        ),
                    ]
                )
            )
