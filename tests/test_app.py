    ...
    mock_response.choices = [
        MagicMock(
            message=MagicMock(
                parsed=Domains(
                    domains=[
                        DomainEntry(domain="testapp.com", reason="Simple and memorable domain name"),
